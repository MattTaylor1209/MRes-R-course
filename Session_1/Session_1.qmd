...
Before we start, run the following chunk (click the green arrow in the corner) which will check that everything we need for today's session is installed (don't worry if you don't understand the code at this point!).

```{r setup}
#| echo: false
# Required packages
required_packages <- c("tidyverse", "yaml", "arrow", "babynames", "curl", "duckdb", "gapminder", 
