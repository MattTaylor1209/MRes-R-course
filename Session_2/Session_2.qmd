...
As we did in session 1, there's a small bit of setup code we need to run to make sure everything we need is installed. To do this, click "File -\> Open File..." and load the file called "setup.R".

Click the "Source" button in the top right ![](images/clipboard-1833989252.png)
